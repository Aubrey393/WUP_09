...
The best two regressor model is H-W with an adjusted R^2 of 0.94.
...
```
The best two regressor model used to predict weight is using height and weight(H-W) with an adjusted R^2 of 0.94.
